...
const RejectRepairRequest = ({ requestData, rejectedBy, onClose, onRejected }) => {
 ...
 const handleReject = async () => {
  ...
  try {
    ...
    onRejected();   // refresh list
    onClose();      // close modal
    setReason("");  // clear remark input
  } catch (err) {
    console.error(err);
    ...
    <div className="modal show d-block" tabIndex="-1">
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content p-3">
          ...
          <p><strong>Employee:</strong> {requestData.requested_user?.fullname}</p>
          <p><strong>Issue:</strong> {requestData.issue_description}</p>
