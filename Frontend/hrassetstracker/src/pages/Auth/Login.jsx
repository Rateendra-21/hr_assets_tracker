...
//       toast.success("Password reset instructions sent to your email or mobile");
//       onClose();
//     } catch {
...
//   // Prevent leading spaces in Employee ID
...
const ForgotPasswordPopup = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Password has been sent on your email");
      onClose();
    } catch {
      toast.error("Failed to send reset instructions");
    } finally {
