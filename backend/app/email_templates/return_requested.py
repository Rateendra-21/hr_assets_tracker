def return_requested_template(asset_name: str, employee_name: str, notes: str) -> str:
    return f"""
    <html>
      <body style="font-family: Arial, sans-serif; font-size: 16px; color: #222; background-color: #f9f9f9; padding: 20px;">
        <div style="max-width: 600px; margin: auto; background-color: white; padding: 20px; border-radius: 8px;">
          <h2 style="color: #004aad;">Asset Return Request</h2>
          <p>Hi,</p>
          <p>A new asset return request has been submitted and requires your attention.</p>
          <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tr>
              <td style="font-weight: bold; padding: 8px; border: 1px solid #ddd;">Notes</td>
              <td style="padding: 8px; border: 1px solid #ddd;">{notes or 'N/A'}</td>
            </tr>
          </table>
          <p style="margin-top: 20px;">Please review and process the return request promptly.</p>
